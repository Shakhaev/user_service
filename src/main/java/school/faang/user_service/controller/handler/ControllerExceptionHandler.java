...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(value = {RecommendationRequestCreatedException.class, RequestAlreadyProcessedException.class, UserAlreadyExistsException.class, PremiumAlreadyExistsException.class})
