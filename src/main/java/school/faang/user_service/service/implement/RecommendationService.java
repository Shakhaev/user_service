...
public class RecommendationService {
    ...
    private final RecommendationReceivedEventPublisher recommendationEventPublisher;
    ...
    public RecommendationService(RecommendationRepository recommendationRepository,
            ...
            RecommendationReceivedEventPublisher recommendationEventPublisher) {
    ...
    public RecommendationDto create(RecommendationDto recommendation) {
        ...
        recommendationEventPublisher.publish(new RecommendationReceivedEventDto(
                recommendId, recommendation.receiverId(), recommendation.authorId(), authorName, LocalDateTime.now()));
    ...
    private void checkPresenceUserSkills(RecommendationDto recommendation) {
        List<Long> skillIdsFromOffer = recommendation.skillOffers() != null ?
                recommendation.skillOffers().stream().map(SkillOfferDto::skillId).toList() :
                List.of();
