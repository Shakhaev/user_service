...
class SmallAvatarFilterTest {
    @Mock
    private AvatarService avatarService;
    @InjectMocks
    private SmallAvatarFilter smallAvatarFilter;
    ...
    public void testResizeAndUploadToMinio() {
        ...
        smallAvatarFilter.resizeAndUploadToMinio(originalImage, formatName, userProfilePic);

        verify(avatarService).uploadToMinio(resizedImage, minioKey);
        verify(userProfilePic).setSmallFileId(minioKey);
    }
}